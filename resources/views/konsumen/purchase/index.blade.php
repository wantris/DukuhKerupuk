            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7">
                    <div class="topnav shadow-sm">
                        <a class="active" href="#home">Semua</a>
                        <a href="{{route('purchase.konsumen', 2)}}">Belum Bayar</a>
                        <a href="{{route('purchase.konsumen', 3)}}">Dikemas</a>
                        <a href="{{route('purchase.konsumen', 4)}}">Dikirim</a>
                        <a href="{{route('purchase.konsumen', 5)}}">Selesai</a>
                        <a href="{{route('purchase.konsumen', 6)}}">Dibatalkan</a>
