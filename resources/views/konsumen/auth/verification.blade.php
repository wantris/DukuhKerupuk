                ...
                <div class="col-12">
                    <div class="card shadow register-card mx-auto">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 text-center" style="padding: 0 35px; margin:40px 0px">
                                    ...
                                    <div class="title-banner-otp mt-4">
                                        ...
                                        <p class="desc-otp mt-2" style="#25c666">Kamu akan mendapat OTP via <span class="font-weight-bold" style="color:#25c666">SMS</span></p>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-center">
                                    <span style="color:#002e5b; font-size:15px">Belum menerima OTP? <a href="{{route('login.mitra')}}" style="text-decoration: none; color:#25c666">Kirim lagi</a> </span>
                                </div>
                            </div>
                        </div>
                    </div>
