            ...
            <div class="row">
              <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                ...
                <div class="card card-success">
                  <div class="card-header"><h4 class="text-success">Verifikasi Nomor Telepon</h4></div>
                  <div class="card-body">
                    <div class="col-12 text-center">
                        <img src="{{url('assets-user/landing/confirmation.png')}}" alt="">
                        <p class="text-secondary">Kamu akan mendapatkan OTP via SMS</p>
                    </div>
                    <form method="POST" action="{{route('verification.konsumen.post')}}" class="needs-validation" novalidate="">
                      @csrf
