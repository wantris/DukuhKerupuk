            ...
            <div class="row">
              <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                <div class="login-brand">
                  <img src="{{url("ogani/img/logo2.png")}}" alt="logo" width="100" class="">
                </div>
                ...
                <div class="card card-success">
                  <div class="card-header"><h4 class="text-success">Login Konsumen</h4></div>
                  <div class="card-body">
                    <form method="POST" action="{{route('login.konsumen.post')}}" class="needs-validation" novalidate="">
                      @csrf
                ...
                <div class="mt-5 text-muted text-center">
                  Belum punya akun Konsumen? <a href="{{route('register.konsumen')}}" style="color: #7fad39">Daftar Sekarang</a>
                </div>
