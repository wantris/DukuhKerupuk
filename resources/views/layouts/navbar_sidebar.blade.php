        ...
        <div class="container-fluid">
          ...
          <div class="navigation__column center" style="">
                <ul class="main-menu menu">
                  ...
                  <li class="menu-item menu-item-has-children dropdown"><a href="#">Mitra & Agen</a>
                    <ul class="sub-menu">
                      <li class="menu-item"><a href="{{route('Mitra')}}">Mitra</a></li>
                      <li class="menu-item"><a href="{{route('Agen')}}">Agen</a></li>
                    </ul>
                  </li>
                  <li class="menu-item menu-item-has-children has-mega-menu">
                    ...
                    <div class="mega-menu">
                      <div class="mega-wrap">
                        ...
                        <div class="mega-column">
                          <h4 class="mega-heading">Produk Kami</h4>
                          <ul class="mega-item">
                  ...
                  <li class="menu-item menu-item-has-children dropdown"><a href="#">Mitra</a>
                    <ul class="sub-menu">
                      <li class="menu-item"><a href="{{route('register.mitra')}}">Daftar</a></li>
                      <li class="menu-item"><a href="{{route('login.mitra')}}">Login</a></li>
                    </ul>
                  </li>
                  <li class="menu-item menu-item-has-children dropdown"><a href="#">Konsumen</a>
                    <ul class="sub-menu">
                      <li class="menu-item"><a href="{{route('register.konsumen')}}">Daftar</a></li>
                      <li class="menu-item"><a href="{{route('login.konsumen')}}">Login</a></li>
                    </ul>
                  </li>
          ...
          <div class="navigation__column right" style="">
