            ...
            <div class="card-body">
                <form action="{{ route('simpan_admin') }}" method="post">
                      ...
                      <div class="form-group mt-3">
                          <input type="text" id="nama" name="nama_admin" class="form-control" placeholder="Nama Admin" >
                      </div>
                      <div class="form-group mt-3">
                      ...
                      <div class="form-group mt-3">
                          <textarea name="alamat_admin" id="alamat" class="form-control" placeholder=" Alamat Admin"></textarea>
                      </div>
                      <div class="form-group mt-3">
