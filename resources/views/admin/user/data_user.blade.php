        ...
        <div class="card card-info card-outline">
            <div class="card-header">
                <div class="card-tools">
                    <a href="{{ route('create_user') }}" class="btn btn-success">Tambah Data
            ...
            <div class="card-body">
                ...
                <tr>
                    ...
                    <td>{{  $item->role  }}</td>
                    <td>
                      <a href="{{ route('edit_user',$item->id_user) }}"><i class="fa fa-edit"></i></a>
                       | 
                      <a href="{{ route('delete_user',$item->id_user) }}"><i class="fa fa-trash" style="color: red"></i></a>
                    </td>
                    </td>
                </tr>
                @endforeach
