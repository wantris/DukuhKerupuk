...
<html lang="en">
  <head>
    ...
    <title>Dukuh Kerupuk | Jual Beli Kerupuk Online</title>
  ...
  <body>
    ...
    <main class="ps-main">
      ...
      <div class="container mt-5">
              <div class="row">
                <div class="col-12">
                  <div class="card box-shadow build-in-scale-fade.build-in-animate" data-aos="fade-left" style="background-color: #05386b">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-12 col-12">
                          <p class="h1 text-white ml-4 mt-5"><b>Selamat Datang di Lingkungan <br><span style="color: #5cdb95" class="font-weight-bold"> Dukuh Kerupuk</span></b></p>
                          <p class="text-white mt-5 ml-4">Dukuh Kerupuk adalah lingkungan yang mempertemukan antara Produsen Kerupuk dengan pembeli sekaligus agen pemasok.</p>
                          <div class="button-banner mt-5 ml-4 mb-5">
                            <a href="#" class="mt-5" id="btn-banner">Lebih Lanjut</a>
                          </div>
                        </div>
                        <div class="col-lg-7 col-md-7 col-sm-12 col-12 text-center">
                          <img class="mb-5" src="{{url('assets-user/landing/landing-banner.png')}}" id="landing-banner" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      {{-- Manfaat Dukuh Kerupuk --}}
      <div class="container-fluid mt-5 " style="background-color:#5cdb95">
        <div class="row mt-4">
          <div class="col-12">
            <p class="h1 font-weight-bold text-center kemudahaan-title">Kemudahan Di Dukuh Kerupuk</p>
          </div>
        </div>
        <div class="row mt-5 mb-5">
          <div class="col-lg-4 col-md-4 text-center">
            <img src="{{url('assets-user/landing/easybuy.png')}}" class="icon-manfaat" alt="">
            <p class="h2 mb-3">Kemudahan Dalam Melakukan Pembelian</p>
          </div>
          <div class="col-lg-4 col-md-4 text-center">
            <img src="{{url('assets-user/landing/easymeet.png')}}" class="icon-manfaat"  alt="">
            <p class="h2 mb-3">Kemudahan dalam berlangganan Produk tanpa harus bertemu</p>
          </div>
          <div class="col-lg-4 col-md-4 text-center">
            <img src="{{url('assets-user/landing/pay.png')}}" class="icon-manfaat" style="width: 113px; heigh:110px" alt="">
            <p class="h2 mb-3">Kemudahan dalam mengelola <br> data penjualan</p>
          </div>
        </div>
      </div>
      ...
      <div class="ps-section--features-product ps-section masonry-root pt-100 pb-100">
        <div class="ps-container">
          <div class="ps-section__header mb-50">
            <h3 class="ps-section__title" data-mask="Kategori" data-aos="fade-right">Kategori kerupuk</h3>
            ...
            <div class="masonry-wrapper" data-col-md="4" data-col-sm="2" data-col-xs="1" data-gap="30" data-radio="100%">
              <div class="ps-masonry">
                    ...
                    <div class="ps-shoe mb-30">
                      ...
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{url("assets-user/upload-produk/kerupuk.jpeg")}}" alt=""><img src="{{url("assets-user/upload-produk/kerupuk.jpeg")}}" alt=""><img src="{{url("assets-user/upload-produk/kerupuk.jpeg")}}" alt=""><img src="{{url("assets-user/upload-produk/kerupuk.jpeg")}}" alt=""></div>
                ...
                <div class="grid-item nike">
                  <div class="grid-item__content-wrapper">
                    <div class="ps-shoe mb-30">
                      <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{("assets-user/upload-produk/kerupuk.jpeg")}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                      </div>
                      <div class="ps-shoe__content">
                        <div class="ps-shoe__variants">
                          <div class="ps-shoe__variant normal"><img src="{{url("assets-user/upload-produk/kerupu2.jpeg")}}" alt=""><img src="{{url("assets-user/upload-produk/kerupuk.jpeg")}}" alt=""><img src="{{url("assets-user/upload-produk/kerupuk.jpeg")}}" alt=""><img src="{{url("assets-user/upload-produk/kerupuk.jpeg")}}" alt=""></div>
                          <select class="ps-rating ps-shoe__rating">
                            <option value="1">1</option>
                            <option value="1">2</option>
                            <option value="1">3</option>
          ...
          <div class="ps-section__content">
            <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-duration="1000" data-owl-mousedrag="on">
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{url("assets-user/upload-produk/kerupuk.jpeg")}}" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{url("user/images/shoe/2.jpg")}}" alt=""><img src="{{url("user/images/shoe/3.jpg")}}" alt=""><img src="{{url("user/images/shoe/4.jpg")}}" alt=""><img src="{{url("user/images/shoe/5.jpg")}}" alt=""></div>
